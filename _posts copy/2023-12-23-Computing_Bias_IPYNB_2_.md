...
---
Look at key words aka "favors" which indicates some sort of preference or inherent bias
...
I think it is an uninetntional bias which stemmed from data bias because the data set for training the AI didn't represent the entierity of racial diversity.
...
- What is another scenario of data collection in everyday applications and situations?
  - Social Media (explicit data collection = what you like or comment on), (implicit = how long you spend on a post)
  - 
...
---
They can include a larger sample with more diversity as well as classiier correction to get rid of current biases held by the computer program. With a larger database of more diveristy as well as the classifier correction, the predictive policing will be more accurate and less biased towards certian groups.
