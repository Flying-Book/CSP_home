...
**Answer:** 
They can use a VPN to prevent tracking, turn off/opt out of cookies, and turn on wifi when not needed. This prevents location and interweb tracking that organixationcs can use to target you.
...
- The orginal message would be hello because if you shift the letter to the left by 5 you can decrypt the code
...
**Answer**
People can access information throught public wifi including coffee shops and airports. If you access a http site, your passwords can be hacked because the datat is not encrpyted. 
